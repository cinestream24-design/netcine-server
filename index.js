...
app.get('/stream/:type/:id.json', async (req, res) => {
    ...
    try {
        ...
        const results = await Promise.all(players.map(async p => {
            ...
            if (resolved.rawM3u8) {
                // Salva em memória temporária e serve via proxy
                ...
                console.log('[NetCine] Servindo via proxy (rawM3u8)');
            } else {
                console.log('[NetCine] Entregando URL direta:', streamUrl.slice(0,80));
            }
